          ...
          {wishlist.map((item) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-2xl border border-gray-100 p-2.5 sm:p-4 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col justify-between group relative"
              >
                {/* Image and Badges */}
                <div className="relative w-full h-32 sm:h-48 bg-[#F8FAF8] rounded-xl overflow-hidden mb-2.5 sm:mb-4">
                  ...
                  <button
                    ...
                    className="absolute top-1.5 right-1.5 sm:top-2.5 sm:right-2.5 w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white/90 hover:bg-red-50 text-gray-400 hover:text-red-600 flex items-center justify-center transition-colors shadow-xs"
